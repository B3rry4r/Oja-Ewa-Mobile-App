...
class _BusinessAccountReviewScreenState
  ...
  Widget build(BuildContext context) {
    ...
    // Relies on AppPageScaffold's default body: fills the viewport when short
    // (so the Spacers centre the content) and scrolls when the content is
    // taller than the screen. Previously this step could not scroll, so the
    // submit button was unreachable on shorter devices.
