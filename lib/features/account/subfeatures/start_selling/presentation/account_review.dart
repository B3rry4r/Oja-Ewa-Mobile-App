...
class _AccountReviewScreenState extends ConsumerState<AccountReviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // AppPageScaffold's default body fills the viewport when the content is
    // short (so the Spacers below still centre it) and scrolls once it grows
    // taller than the screen. This step previously could not scroll at all,
    // leaving the submit button unreachable on shorter devices.
