...
/// Schools screen - Shows school businesses from the 'school' category type
/// Backend returns: Fashion, Music, Catering, Beauty
    ...
    return categoriesAsync.when(
      ...
      data: (cats) {
        ...
        return CategoryScreen(
          ...
          categoryDescription: 'Discover schools and educational services',
          sections: sections,
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (_) => ProductListingScreen(
                  ...
                  breadcrumb: 'Education • ${section.title}',
