...
class SellerProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final productsAsync = ref.watch(
      publicSellerProductsPagedProvider((sellerId: sellerId)),
    );
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        height: 80,
                        child:
                            seller.businessLogo == null ||
                                seller.businessLogo!.trim().isEmpty
                ...
                if ((seller.instagram ?? '').trim().isNotEmpty ||
                    (seller.facebook ?? '').trim().isNotEmpty) ...[
                  Text(
                    'Socials',
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: state.isLoadingMore
                                  ...
                                  : () => ref
                                        .read(
                                          publicSellerProductsPagedProvider((
                                            sellerId: sellerId,
                                          )).notifier,
                                        )
                                        .loadMore(),
